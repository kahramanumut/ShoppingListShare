...
if(@$_SESSION["oturum"]==true  && @$_SESSION["rol"]==1){
    echo '
        <script>
...
if($_POST){
    $kadi = $_POST["KullAdi"];
    $parola = $_POST["Sifre"];
    $bul = mysql_query("SELECT * FROM kisi WHERE KullAdi = '$kadi' && Sifre = '$parola' && Rol='1'");
    ...
    if($say > 0 ){
        ...
        echo '
        <script>
        alert("Kullanıcı adı veya parola yanlış yada yetkisiz giriş.");
